...
if __name__ == "__main__":
    src = '/Users/ernstmulders/Dropbox/TU Delft (master)/Cyber security/Lab 1/data_for_student_case.csv'
...
x_mean = x;
des = '/Users/ernstmulders/Dropbox/TU Delft (master)/Cyber security/Lab 1/original_data.csv'
des1 = '/Users/ernstmulders/Dropbox/TU Delft (master)/Cyber security/Lab 1/aggregate_data.csv'
ch_dfa = open(des,'w')
