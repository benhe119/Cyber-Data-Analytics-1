...
# print "\nRaw data shape from KNIME dataset file: dataset.csv"
# print df.shape
...
# convert 'checks' string to vector
...
# del df_merged['checks']

#print df_merged.describe()

df_merged.drop('checks',axis=1,inplace=True)

#df_merged.drop('checks')
#df_merged.drop('rowID')

# print df_merged.describe()

#df_merged.to_csv(path_or_buf='./processeddataset.csv')
