...
df = pd.read_csv("./data/BATADAL_training_dataset_1.csv", delimiter=',', parse_dates=True, dayfirst=True, index_col='DATETIME');
...
if analysisMethod == 'ARMA':
    ...
    datetimefield = df.index


    for field in ["L_T1"]:
        fitARMA(df[field],datetimefield,p=2,q=0)
